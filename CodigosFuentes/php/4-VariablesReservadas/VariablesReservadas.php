<?php
	...
	//isset():Determina si un campo o variable está definido/a.
	...
	################################################################################
	Nuevo();
	Titulo('Variable $_ENV');
	if(isset($_ENV))
		print_r($_ENV);//testear var_dump($_ENV);
	
	
	################################################################################
    Nuevo();
	Titulo('Variable $_GLOBALS');
	
	//Crear variables globales.
	$_GLOBALS['$variableGlobal1']=0;
	$_GLOBALS['$variableGlobal2']="Ejemplo variables reservadas";
	
	if(isset($_GLOBALS))
		print_r($_GLOBALS);//testear var_dump($_GLOBALS);
